...
# фонова музика
mixer.init()
mixer.music.load('Turtle Crusher.mp3')
mixer.music.play()
...
img_back = "galax.png"  # фон гри
img_hero = "playt.png"  # герой
img_bullet = "light.png" # куля
img_enemy = "evil.png"  # ворог
img_ast = 'ret.png'
...
for i in range(1, 6):
    monster = Enemy(img_enemy, randint(
        80, win_width - 80), -40, 70, 50, randint(1, 5))
    monsters.add(monster)
 
asteroids = sprite.Group()
for i in range(1,3):
    asteroid = lus(img_ast, randint(30, win_width - 30), -40, 70, 50, randint(1,7))
    ...
    if not finish:
        ...
        if rel_time:
            ...
            if now_time - last_time < 3:
                reload = font2.render('обід, на борщ поїш...', 1, (150, 0, 0))
